...
<div class="form-group col-sm-6">
    ...
    {!! Form::file('image', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$page->image ? asset('storage/'.$page->image) : '', 'data-allowed-file-extensions' => 'jpg jpeg png', 'data-max-file-size' => '1M']) !!}
</div>
