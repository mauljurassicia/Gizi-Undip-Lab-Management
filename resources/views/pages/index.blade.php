        ...
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <!-- <h1 class="mg-b-0 tx-spacing--1">Pages</h1> -->
                </div>
            </div>
            
            @include('flash::message')
            
            <h4 class="mg-b-10">Pages</h4>

            <p class="mg-b-30">
                This is a list of your <code>Pages</code>, you can manage by clicking on action buttons in this table.
            </p>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                ...
                <div class="d-none d-md-block">
                    ...
                    <a class="btn btn-sm btn-primary btn-uppercase" href="{!! route('pages.create') !!}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
