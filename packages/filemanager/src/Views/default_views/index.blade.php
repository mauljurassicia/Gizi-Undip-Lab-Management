                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid ">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li><button class="btn btn-info btn-cons" id="single-upload"><i class="fa fa-upload"></i> <span class="btn-text-wrapper">Upload</span></button></li>
                            <li><button class="btn btn-info btn-cons" data-toggle="modal" data-target="#modalCreateFolder"><i class="fa fa-folder"></i> <span class="btn-text-wrapper">Create Folder</span></button></li>
                            ...
                            <li class="move"><button class="btn btn-default"><i class="fa fa-arrows"></i> <span class="btn-text-wrapper">Move</span></button></li>
                            <li class="delete"><button class="btn btn-default"><i class="fa fa-trash"></i> <span class="btn-text-wrapper">Delete</span></button></li>
                            <li class="preview"><button class="btn btn-default"><i class="fa fa-eye"></i> <span class="btn-text-wrapper">Preview</span></button></li>
                            <li class="crop"><button class="btn btn-default"><i class="fa fa-crop"></i> <span class="btn-text-wrapper">Crop</span></button></li>
                            <li class="find">
...
@section('scripts')
    <!-- added by dandisy, for template using jquery version 3 -->
