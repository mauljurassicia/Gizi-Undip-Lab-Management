...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group col-sm-12">
            ...
            {!! Form::text('name', @$laborant->name, ['class' => 'form-control']) !!}
        </div>

        <!-- Email Field -->
        <div class="form-group col-sm-12">
            {!! Form::label('email', 'Email:') !!}
            {!! Form::email('email', @$laborant->email, ['class' => 'form-control', 'disabled' => isset($laborant)]) !!}
        </div>

        <!-- identity Number Field -->
        <div class="form-group col-sm-12">
            {!! Form::label('identity_number', 'NIK:') !!}
            {!! Form::text('identity_number', @$laborant->identity_number, ['class' => 'form-control']) !!}
        </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('laborants.index') !!}" class="btn btn-light">Cancel</a>
</div>
