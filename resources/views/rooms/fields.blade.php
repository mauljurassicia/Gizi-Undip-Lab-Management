...
<div class="form-group col-sm-6">
    ...
    <div class="input-group">
        {!! Form::number('volume', @$room->volume, ['class' => 'form-control', 'min' => '0']) !!}
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('type', $typeRooms, null, [
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('pic_id', $pic->pluck('name', 'id'), null, [
        'class' => 'form-control select2',
...
<div class="form-group col-sm-12">
    ...
    {!! Form::textarea('description', null, ['class' => 'form-control my-editor2']) !!}
</div>
        ...
        <div class="form-group">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" :id="'operational_days_' + day"
                    :name="'operational_days[' + day + ']'" x-model="operationalDays[day]">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            <input type="time" :id="'operational_time_' + day + '_start'" class="form-control"
                                :name="'operational_days[' + day + '][start]'" x-model="operationalTime[day].start">
                        </div>
                        ...
                        <div class="col-auto">
                            <input type="time" :id="'operational_time_' + day + '_end'" class="form-control"
                                :name="'operational_days[' + day + '][end]'" x-model="operationalTime[day].end">
                        </div>
                    </div>
                </div>
            </template>
