...
<div class="form-group col-sm-12">
    ...
    {!! Form::textarea('description', @$course->description, ['class' => 'form-control my-editor2']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    {!! Form::file('banner', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$course->banner ? asset('storage/'.$course->banner) : '', 'data-allowed-file-extensions' => 'jpg jpeg png', 'data-max-file-size' => '1M']) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::file('thumbnail', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$course->thumbnail ? asset('storage/'.$course->thumbnail) : '', 'data-allowed-file-extensions' => 'jpg jpeg png', 'data-max-file-size' => '1M']) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('status', ['1' => 'Active', '0' => 'Inactive'], @$course->status, ['class' => 'form-control']) !!}
</div>
