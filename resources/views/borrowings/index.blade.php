                ...
                function borrowing() {
                    return {
                        ...
                        async fetchBorrowings() {
                            ...
                            this.borrowings = await fetch('{{ route("borrowings.get") }}?'+(this.searchEquipment ? '&searchEquipment=' + this.searchEquipment : '') + (this.roomFilter ? '&roomFilter=' + this.roomFilter : '') + (this
